...
.method public generateNativeSymbolFiles(Ljava/io/File;Ljava/io/File;Lcom/google/firebase/crashlytics/buildtools/ndk/NativeSymbolGenerator;)V
    ...
    .line 307
    .local v6, "symbolFile":Ljava/io/File;
    if-nez v6, :cond_2

    .line 308
    const-string v7, "Null symbol file generated for %s"
    ...
    .line 310
    :cond_2
    const-string v7, "Generated symbol file: %s (%,d bytes)"
    ...
    invoke-static {v7}, Lcom/google/firebase/crashlytics/buildtools/Buildtools;->logD(Ljava/lang/String;)V
    :try_end_2
    ...
    .end local v6    # "symbolFile":Ljava/io/File;
    :goto_3
    goto :goto_2
    ...
    .line 299
    const-string v2, "No native libraries found at %s. %s"
    ...
    .line 263
    const-string v1, "Unstripped native library path does not exist: %s. %s"
...
.method public injectMappingFileIdIntoResource(Ljava/io/File;Ljava/lang/String;)Z
    ...
    .line 156
    const-string v2, "mappingFileId was NOT updated; correct value already present."
...
.method public uploadMappingFile(Ljava/io/File;Ljava/lang/String;Lcom/google/firebase/crashlytics/buildtools/AppBuildInfo;Lcom/google/firebase/crashlytics/buildtools/Obfuscator;)V
    ...
    .line 241
    .local v1, "mappingService":Lcom/google/firebase/crashlytics/buildtools/api/MappingFileService;
    ...
    invoke-static {v0}, Lcom/google/firebase/crashlytics/buildtools/Buildtools;->logI(Ljava/lang/String;)V
