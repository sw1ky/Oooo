...
.method private readArmVersion(JJ)Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/base/Optional;
    ...
    iget-object v1, v0, Lcom/google/firebase/crashlytics/buildtools/ndk/internal/elf/ElfDataParser;->_fileReader:Lcom/google/firebase/crashlytics/buildtools/utils/io/ByteReader;
    ...
    .line 379
    iget-object v4, v0, Lcom/google/firebase/crashlytics/buildtools/ndk/internal/elf/ElfDataParser;->_fileReader:Lcom/google/firebase/crashlytics/buildtools/utils/io/ByteReader;

    const/4 v9, 0x4

    invoke-virtual {v4, v9}, Lcom/google/firebase/crashlytics/buildtools/utils/io/ByteReader;->readInt(I)I
    ...
    sget-object v11, Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/base/Charsets;->UTF_8:Ljava/nio/charset/Charset;

    invoke-virtual {v4, v11}, Lcom/google/firebase/crashlytics/buildtools/utils/io/ByteReader;->readNullTerminatedString(Ljava/nio/charset/Charset;)Ljava/lang/String;
    ...
    .line 393
    iget-object v5, v0, Lcom/google/firebase/crashlytics/buildtools/ndk/internal/elf/ElfDataParser;->_fileReader:Lcom/google/firebase/crashlytics/buildtools/utils/io/ByteReader;

    invoke-direct {p0, v5, v9, v10}, Lcom/google/firebase/crashlytics/buildtools/ndk/internal/elf/ElfDataParser;->findArmVersionInSection(Lcom/google/firebase/crashlytics/buildtools/utils/io/ByteReader;J)Lcom/google/firebase/crashlytics/buildtools/reloc/com/google/common/base/Optional;
    ...
    .line 396
    :cond_0
    iget-object v11, v0, Lcom/google/firebase/crashlytics/buildtools/ndk/internal/elf/ElfDataParser;->_fileReader:Lcom/google/firebase/crashlytics/buildtools/utils/io/ByteReader;

    iget-object v12, v0, Lcom/google/firebase/crashlytics/buildtools/ndk/internal/elf/ElfDataParser;->_fileReader:Lcom/google/firebase/crashlytics/buildtools/utils/io/ByteReader;

    invoke-virtual {v12}, Lcom/google/firebase/crashlytics/buildtools/utils/io/ByteReader;->getCurrentOffset()J

    move-result-wide v12

    add-long/2addr v12, v9

    invoke-virtual {v11, v12, v13}, Lcom/google/firebase/crashlytics/buildtools/utils/io/ByteReader;->seek(J)V
    ...
    .line 382
    :cond_1
    const-string v4, "Section size %d is greater than remaining data length %d."
    ...
    invoke-direct {v11, v5}, Ljava/io/IOException;-><init>(Ljava/lang/String;)V

    throw v11

    .line 400
    .end local v4    # "errorString":Ljava/lang/String;
    .end local v9    # "sectionRemaining":J
    :cond_2
    const-string v4, "Crashlytics did not find an ARM public attributes subsection."
    ...
    .line 369
    const-string v5, "Invalid data found at offset %d."
