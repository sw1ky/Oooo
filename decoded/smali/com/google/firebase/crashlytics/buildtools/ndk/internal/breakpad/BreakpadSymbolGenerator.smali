...
.method public generateSymbols(Ljava/io/File;Ljava/io/File;)Ljava/io/File;
    ...
    .line 137
    invoke-static {v4, v5, v3}, Lcom/google/firebase/crashlytics/buildtools/ndk/NativeSymbolGenerator$-CC;->createSymbolFileBasename(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    .line 139
    .local v4, "symbolFileBasename":Ljava/lang/String;
    new-instance v5, Ljava/io/File;
    ...
    .line 140
    .local v5, "breakpadOutputFile":Ljava/io/File;
    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string v7, "Renaming Breakpad symbol file to: "
    ...
    .end local v4    # "symbolFileBasename":Ljava/lang/String;
    .end local v5    # "breakpadOutputFile":Ljava/io/File;
    :cond_1
